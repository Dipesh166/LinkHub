  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const userData = {
        ...
        links: [],
        slug: '', // Add empty slug, it will be generated by the saveUserProfile function
        theme: {
          background: "gradient",
      ...
      if (user && user.uid) {
        try {
          const profileId = await saveUserProfile(user.uid, userData);
    ...
    <div className="min-h-screen flex flex-col items-center justify-center p-6 bg-gradient-to-br from-gray-900 via-purple-900 to-black relative overflow-hidden">
      ...
      {error && (
        <motion.div
          ...
          exit={{ opacity: 0, y: 20 }}
          className="fixed top-4 right-4 bg-red-500/10 border border-red-500/20 text-red-400 p-4 rounded-lg backdrop-blur-sm"
        >
          {error}
        </motion.div>
      )}
